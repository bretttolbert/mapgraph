...
OBJ = main.o MapGraph.o StringUtils.o Game.o Demos.o USCountiesGame.o SvgFile.o CsvFile.o USCountiesSvgFile.o USStatesSvgFile.o IntegerIdAdjacencyListFile.o CsvAdjacencyListFile.o USCountiesAdjacencyListFile.o TravelingSalesmanProblem.o tinyxml2.o
...
MapGraph.o: MapGraph.cpp
	g++ $(CC_FLAGS) MapGraph.cpp
